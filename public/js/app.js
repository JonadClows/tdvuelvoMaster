...
// Botón confirmar al registrar cuenta bancaria
$('#frmRegistroCuenta').submit(function(event){
    event.preventDefault();
    $('#registroCuentaModal').modal('show');
    // 1.- Verificar que haya ingresado todos los campos
    // 2.- Empaquetar los datos y hacer el envío
