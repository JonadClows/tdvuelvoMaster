...
<body>
    ...
    <table>
        <thead>
            <tr>
                <th>
                    <h5>ACUERDO DE ENDOSO DE NOTA DE CRÉDITO DESMATERIALIZADA DEL SERVICIO DE RENTAS INTERNAS</h5>
                </th>
            </tr>
        </thead>
        <tbody style="">
            ...
            <tr>
                <td style="text-align: justify;">
                    <p style="font-size: 13px;">En prueba de conformidad, firman las partes electrónicamente:</p>
                </td>
            </tr>
            <tr>
                <td><br></td>
            ...
            <tr>
                <td style="text-align: center;font-weight: bold;">_________________________</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: center;">
                    <h5>LEXTAX SERVICIOS TRIBUTARIOS INTEGRALES S.A.</h5>
                </td>
            </tr>
        </tbody>
    </table>
